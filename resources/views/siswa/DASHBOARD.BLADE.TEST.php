    ...
    @if(!is_null($siswa->nilai_rata_rata) && $siswa->nilai_rata_rata < 70)
        <div class="container">
            <div class="alert alert-warning d-flex align-items-center alert-dismissible fade show mb-4" role="alert">
                ...
                <div>
                    Nilai rata-rata Anda di bawah 70. Anda harus mengikuti remedial untuk meningkatkan nilai.
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 border-0 rounded-4 shadow-sm">
                        <div class="card-body p-4">
                            ...
                            @if (is_null($siswa->{'nilai_' . Str::snake($mapel->mata_pelajaran)}))
                            ...
                            @else
                                <div class="d-grid">
                                    <button class="btn btn-secondary btn-lg rounded-pill d-flex align-items-center justify-content-center gap-2" disabled>
